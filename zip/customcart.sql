...
INSERT INTO `attribute` (`attribute_id`, `attribute_name`, `attribute_code`, `attribute_type`) VALUES
(1,	'Color',	'color',	'select'),
(2,	'Size',	'size',	'select'),
(3,	'Sample',	'sample',	'text');
...
CREATE TABLE `products` (
  ...
  UNIQUE KEY `lsfs_item_id` (`lsfs_item_id`),
...
INSERT INTO `product_attribute` (`value_id`, `product_id`, `attribute_id`, `value`) VALUES
(1,	9,	1,	'Yellow'),
(2,	10,	1,	'Yellow'),
(3,	16,	1,	'White'),
(4,	17,	1,	'Yellow'),
